...
permalink: /programming/c/api-reference/index.html
---
...
### Initialize and Destroy
  ...
  | [`DBR_GetInstance`](methods/initialize-and-destroy.md#dbr_getinstance) | Creates an instance of Dynamsoft Barcode Reader. |
  | [`DBR_RecycleInstance`](methods/initialize-and-destroy.md#dbr_recycleinstance) | Destroys an instance of Dynamsoft Barcode Reader. |
...
### General Functions
  ...
  | [`DBR_FreeString`](methods/general.md#dbr_freestring) | Free memory allocated for string. |
...
## Structs
 ...
 | [`InstancePoolStatus`]({{ site.dbr_structs }}InstancePoolStatus.html?src=c) | Stores the status of an instance pool. |
