...
permalink: /programming/c/api-reference/methods/license-v8.2.0.html
---
...
#### Parameters
`[in, out] pLTSConnectionParameters` The struct of [`DM_LTSConnectionParameters`]({{ site.dbr_structs }}DMLTSConnectionParameters.html).   
