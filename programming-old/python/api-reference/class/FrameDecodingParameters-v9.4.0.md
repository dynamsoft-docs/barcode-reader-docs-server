...
permalink: /programming/python/api-reference/class/FrameDecodingParameters-v9.4.0.html
---
...
| [`height`](#height) | *int* |
| [`stride`](#stride) | *int* |
| [`image_pixel_format`](#imagepixelformat) | [`ImagePixelFormat`]({{ site.dbr_python_enumerations }}other-enums.html#imagepixelformat) |
