...
permalink: /programming/python/api-reference/class/PublicRuntimeSettings-v9.4.0.html
---
...
**Value Range**     
    Any one of the [`ResultCoordinateType`]({{ site.dbr_python_enumerations }}result-enums.html#resultcoordinatetype) Enumeration items
