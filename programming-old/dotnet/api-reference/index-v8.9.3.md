...
permalink: /programming/dotnet/api-reference/index-v8.9.3.html
---
...
### Other Enumeration
  ...
  | Enumeration | Description |
  |-------------|-------------|
  | [`DM_ChargeWay`]({{ site.dotnet_enumerations }}other-enums.html#dm_chargeway) | Describes the charge way. |
  | [`DM_DeploymentType`]({{ site.dotnet_enumerations }}other-enums.html#dm_deploymenttype) | Describes the deployment type. |
  | [`DM_LicenseModule`]({{ site.dotnet_enumerations }}other-enums.html#dm_licensemodule) | Describes Dynamsoft license modules. |
  | [`DM_UUIDGenerationMethod`]({{ site.dotnet_enumerations }}other-enums.html#dm_uuidgenerationmethod) | Describes the UUID generation method. |
  ...
  | [`Product`]({{ site.dotnet_enumerations }}other-enums.html#product) | Describes Dynamsoft products. |
