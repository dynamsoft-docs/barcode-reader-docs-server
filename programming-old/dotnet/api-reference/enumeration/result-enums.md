...
title: Result Enumerations - Dynamsoft Barcode Reader SDK .NET Edition
description: This article shows Result Enumerations of Dynamsoft Barcode Reader SDK .NET Edition.
...
permalink: /programming/dotnet/api-reference/enumeration/result-enums.html
---
...
```csharp
enum Dynamsoft.DBR.EnumIMResultDataType
```
...
```csharp
enum Dynamsoft.DBR.EnumIntermediateResultSavingMode
```
...
```csharp
enum Dynamsoft.DBR.EnumIntermediateResultType
```
...
```csharp
enum Dynamsoft.EnumResultCoordinateType
```
...
```csharp
enum Dynamsoft.DBR.EnumTextResultOrderMode
```
