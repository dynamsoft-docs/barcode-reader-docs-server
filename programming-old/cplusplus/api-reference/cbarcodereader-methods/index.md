...
permalink: /programming/cplusplus/api-reference/cbarcodereader-methods/index.html
---
...
## License
  ...
  | [`GetInstancePoolStatus`](license.md#getinstancepoolstatus) | Gets a struct to represent the status of an instance pool. |
