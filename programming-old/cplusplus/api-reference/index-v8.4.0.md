...
permalink: /programming/cplusplus/api-reference/index-v8.4.0.html
---
...
## Structs
 ...
 | [`DM_LTSConnectionParameters`]({{ site.dbr_structs }}DMLTSConnectionParameters.html?src=cpp) | Defines a struct to configure the parameters to connect to license tracking server. |
