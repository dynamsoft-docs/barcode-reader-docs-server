...
description: This article enumerates the error codes of Dynamsoft Barcode Reader v9.4.0
keywords: error code, enumeration
permalink: /programming/c-cplusplus/enumeration/error-code-v9.4.0.html
---
