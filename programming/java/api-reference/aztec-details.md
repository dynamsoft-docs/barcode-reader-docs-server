...
description: API reference for the AztecDetails class in Dynamsoft Barcode Reader Java Edition, which stores the row count, column count, and layer number of a decoded Aztec barcode.
