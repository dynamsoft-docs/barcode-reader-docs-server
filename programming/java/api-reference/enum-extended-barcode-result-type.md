...
description: Reference for the ExtendedBarcodeResultType enumeration in DBR Java Edition, which classifies the type of text result returned from a barcode scan (e.g., standard, candidate, partial).
