...
### Error code -10062
  ...
  | Error Code | Value | Description |
  |-------------------|-------------------|-------------|
  | `DBR_PHARMACODE_LICENSE_INVALID` | -10062 | The Pharmacode license is invalid. |
...
### Error code -20012
  ...
  | Error Code | Value | Description |
  |-------------------|-------------------|-------------|
  | `DM_LICENSE_CACHE_USED` | -20012 | Online license validation failed due to network issues. Using cached license information for validation. |
