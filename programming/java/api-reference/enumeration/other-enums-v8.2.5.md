...
description: This article shows other Enumerations of Dynamsoft Barcode Reader v8.2.5 for Java Programming Laguage
...
permalink: /programming/java/api-reference/enumeration/other-enums-v8.2.5.html
---
