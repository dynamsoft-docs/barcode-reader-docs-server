...
description: Reference for the DeblurMode enumeration in DBR Java Edition, listing image processing algorithms applied to localized barcode zones to generate a binary image for final barcode decoding.
