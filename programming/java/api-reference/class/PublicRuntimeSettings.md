...
permalink: /programming/java/api-reference/class/PublicRuntimeSettings.html
---
...
```
**Value Range**     
    Each array item can be any one of the [`EnumDeblurMode`]({{ site.dbr_java_enumerations }}parameter-mode-enums.html#deblurmode) Enumeration items.
