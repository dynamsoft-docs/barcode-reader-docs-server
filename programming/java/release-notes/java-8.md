...
title: Release Notes v8.x - Dynamsoft Barcode Reader SDK Java Edition
description: Release notes for DBR SDK Java Edition v8.x, covering new localization modes, confidence scoring improvements, and other enhancements.
