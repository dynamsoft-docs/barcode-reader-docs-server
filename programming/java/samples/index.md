...
| <a href="https://github.com/Dynamsoft/barcode-reader-java-samples/tree/main/Samples/GridBarcodeScanner" target="_blank">GridBarcodeScanner</a> | This sample demonstrates a multi-phase pipeline for decoding a large barcode grid from a single image, maximizing the decode rate with low latency. |
