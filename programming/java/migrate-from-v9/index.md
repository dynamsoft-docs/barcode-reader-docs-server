...
description: Migration guide from DBR Java Edition v9.x to v11.x. Details API changes for license, decoding, template, runtime settings, and removed properties under DCV architecture.
