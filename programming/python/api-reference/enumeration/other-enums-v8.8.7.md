...
description: This article shows other Enumerations of Dynamsoft Barcode Reader v8.8.7 for Python Programming Laguage
...
permalink: /programming/python/api-reference/enumeration/other-enums-v8.8.7.html
---
