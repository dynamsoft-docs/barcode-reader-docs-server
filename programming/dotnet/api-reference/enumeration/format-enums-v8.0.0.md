...
permalink: /programming/dotnet/api-reference/enumeration/format-enums-v8.0.0.html
---
...
```csharp
enum Dynamsoft.DBR.EnumBarcodeFormat 
```
...
```csharp
enum Dynamsoft.DBR.EnumBarcodeFormat_2
```
