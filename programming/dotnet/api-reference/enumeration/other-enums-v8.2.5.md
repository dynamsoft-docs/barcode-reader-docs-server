...
title: Other Enumerations - Dynamsoft Barcode Reader .NET Edition
...
permalink: /programming/dotnet/api-reference/enumeration/other-enums-v8.2.5.html
---
...
```csharp
enum Dynamsoft.EnumDMChargeWay
```
...
```csharp
enum Dynamsoft.EnumDMDeploymentType
```
...
```csharp
enum Dynamsoft.EnumDMLicenseModule
```
...
```csharp
enum Dynamsoft.EnumDMUUIDGenerationMethod
```
